...
if __name__ == "__main__":
    ...
    city1 = City("Osak", config_fn="./config/reproduce/osak.json")
    city2 = City("Glas", config_fn="./config/glas.json")
    city3 = City("Glas", config_fn="./config/reproduce/glas.json")
    for city in [city0, city1, city2, city3]:
        print(city)
        main(city)
